...
var CatalogPage = (function () {
    function CatalogPage(productProvider, parametersService, categoryProvider, parameterProvider, contractProvider, sortingService, navbarService, route, router, globalService) {
    ...
    CatalogPage.prototype.selectCategory = function () {
        var _this = this;
        this.categoryProvider.getTree().subscribe(function (response) { return _this.category = response.find(function (cat) { return cat.url == _this.categoryName; }); });
    };
