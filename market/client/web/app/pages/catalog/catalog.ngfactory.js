...
import * as i6 from "../../controls/pager/pager.ngfactory";
import * as i7 from "../../controls/pager/pager";
import * as i8 from "./components/filter/filter.ngfactory";
import * as i9 from "./components/filter/filter";
import * as i10 from "./components/sorting/sorting.ngfactory";
import * as i11 from "./components/sorting/sorting";
import * as i12 from "../../services/sort";
import * as i13 from "./catalog";
import * as i14 from "../../services/status";
import * as i15 from "../../providers/product";
import * as i16 from "../../services/parameters";
import * as i17 from "../../providers/category";
import * as i18 from "../../providers/parameter";
import * as i19 from "../../providers/contract";
import * as i20 from "../../services/navbar";
import * as i21 from "@angular/router";
import * as i22 from "../../services/global";
import * as i23 from "../../services/seo";
...
function View_CatalogPage_3(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 1, "pager", [], null, [[null, "onPageChange"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("onPageChange" === en)) {
        var pd_0 = (_co.changePage($event) !== false);
        ad = (pd_0 && ad);
    } return ad; }, i6.View_PagerControl_0, i6.RenderType_PagerControl)), i0.ɵdid(1, 49152, [[1, 4]], 0, i7.PagerControl, [], { category: [0, "category"] }, { onPageChange: "onPageChange" })], function (_ck, _v) { var _co = _v.component; var currVal_0 = _co.categoryId; _ck(_v, 1, 0, currVal_0); }, null); }
function View_CatalogPage_4(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 0, "div", [["class", "d-flex flex-column"]], [[8, "innerHTML", 1]], null, null, null, null))], null, function (_ck, _v) { var _co = _v.component; var currVal_0 = _co.category.longDescription; _ck(_v, 0, 0, currVal_0); }); }
export function View_CatalogPage_0(_l) { return i0.ɵvid(0, [i0.ɵqud(671088640, 1, { pagerComponent: 0 }), i0.ɵqud(402653184, 2, { catalogFilter: 0 }), (_l()(), i0.ɵeld(2, 0, null, null, 14, "div", [["class", "d-flex flex-nowrap"]], null, null, null, null, null)), (_l()(), i0.ɵted(-1, null, ["\n    "])), (_l()(), i0.ɵeld(4, 0, null, null, 11, "div", [["class", "c-buttons"]], null, null, null, null, null)), i0.ɵdid(5, 278528, null, 0, i4.NgClass, [i0.IterableDiffers, i0.KeyValueDiffers, i0.ElementRef, i0.Renderer2], { klass: [0, "klass"], ngClass: [1, "ngClass"] }, null), i0.ɵpod(6, { "hidden-md-up": 0, "hidden-md-down": 1 }), (_l()(), i0.ɵted(-1, null, ["\n        "])), (_l()(), i0.ɵeld(8, 0, null, null, 2, "a", [["class", "c-button pointer text-nowrap"]], null, [[null, "click"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("click" === en)) {
